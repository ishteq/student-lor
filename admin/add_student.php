...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO students(student_id, first_name, last_name, email, password, gender,department, batch) VALUES(:studid,:fname,:lname,:email,:password,:gender,:department, :batch)";
                                    ...
                                    <form name="addemp" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="batch" type="text" autocomplete="off"
                                                    required id="batch" placeholder="eg: 2022-2026">
                                            </div>
