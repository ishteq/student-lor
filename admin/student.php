                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark">
                                    <center><a href="add_student.php" class="btn btn-sm btn-info">Add New Student</a>
                                    </center>
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover table-striped text-center" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $sql = "SELECT student_id, first_name, last_name, department, email, batch, gender from students";
