...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO hods(hod_id, first_name, last_name, email, password,department) VALUES(:studid,:fname,:lname,:email,:password,:department)";
                                    ...
                                    <form name="addemp" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="studid" class="col-form-label">HOD ID</label>
