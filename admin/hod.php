                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark">
                                    <center><a href="add_hod.php" class="btn btn-sm btn-info">Add New HOD</a>
                                    </center>
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover table-striped text-center" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $sql = "SELECT hod_id, first_name, last_name, department, email from hods";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($result->hod_id); ?></td>
